...
<div id="content" role="main">
    <div class="container">
        <section class="row">
            <a href="#show-pet" class="visually-hidden-focusable" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <section class="row">
            <div id="show-pet" class="col-12 content scaffold-show" role="main">
                ...
                <f:display bean="pet" listClass="container" listItemClass="row mb-3" labelClass="form-label col-sm-3 text-sm-end" valueClass="col-sm-9" />
                <g:form resource="${this.pet}" controller="${controllerName}" method="DELETE">
                    <fieldset class="bg-body-tertiary">
                        <g:link class="btn btn-outline-primary" action="edit" resource="${this.pet}" controller="${controllerName}">
