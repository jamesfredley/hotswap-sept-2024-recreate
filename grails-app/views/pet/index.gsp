...
<div id="content" role="main">
    <div class="container">
        <section class="row">
            <a href="#list-pet" class="visually-hidden-focusable" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <section class="row">
            <div id="list-${propertyName}" class="col-12 content scaffold-list" role="main">
                ...
                <f:table class="scaffold table table-striped table-sm" controller="${controllerName}" collection="${petList}"/>

                <g:if test="${petCount > params.int('max')}">
                    <div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
                        <g:paginate activeClass="active" class="btn" total="${petCount ?: 0}" />
                    </div>
                </g:if>
            </div>
        </section>
