...
<div id="content" role="main">
    <div class="container">
        <section class="row">
            <a href="#create-pet" class="visually-hidden-focusable" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <section class="row">
            <div id="create-pet" class="col-12 content scaffold-create" role="main">
                ...
                <g:form resource="${this.pet}" controller="${controllerName}" method="POST">
                    <fieldset class="form">
                        <f:all bean="pet" class="row" requiredClass="mb-3 required" labelClass="col-sm-2 col-form-label text-sm-end" divClass="col-sm-10" widget-class="form-control" widget-invalidClass="is-invalid" widget-selectDateClass="w-auto form-select d-inline" widget-checkBoxClass="form-check-input align-middle" />
                    </fieldset>
